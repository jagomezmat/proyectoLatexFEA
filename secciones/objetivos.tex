...
\begin{enumerate}
    ...
    \item Desarrollar una ruta sintética verde utilizando clara de huevo (ovoalbúmina) como bioprecursor de nitrógeno y azufre, determinando la ventana cinética óptima (\textit{sweet spot}) a 1:15~minutos de pirólisis y calculando su \textit{bandgap} óptico directo ($E_g = 3{,}334$~eV).
